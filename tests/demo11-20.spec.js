...
test('check app 11', async ({ page }) => {
  ...
  await expect(await page.locator("(//div[@class='text-white text-[32px] leading-[42px] font-semibold whitespace-normal text-center sm:text-left line-clamp-4'])[1]")).toContainText( appName, { timeout: 7000 });     
